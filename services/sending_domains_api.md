...
**Note:** Deletion of a sending domain while the system is processing messages which use that sending domain may result
in messages being rejected.  It is advisable to finish all transmissions associated with the sending domain before deleting it.
