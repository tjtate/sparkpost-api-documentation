...
|shared_with_subaccounts | boolean | Setting to true allows this domain to be used by subaccounts | no | Defaults to true, only available to domains belonging to a master account|
