...
## Webhook Event Documentation [/api/v1/webhooks/events/documentation]

### List sample values and event descriptions [GET]

List example webhook events and metadata about events and properties.
...
An array of sample webhook events

+ Request

  + Parameters
  + events =`delivery,bounce` (optional, string, `delay`) A list of event types to view samples of.  Defaults to all events. 
